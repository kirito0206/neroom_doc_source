...
2. 调用 [`endRoom`](https://doc.yunxin.163.com/neroom/api-refer/web/typedoc/Latest/zh/html/interfaces/index.NERoomContext.html#endRoom) 接口删除房间。

   删除房间成功后，会触发 `NERoomListener` 协议中的 `onRoomEnded` 回调方法。
...
| **方法** | **功能描述** |
|:--|:--|
|[endRoom](https://doc.yunxin.163.com/neroom/api-refer/web/typedoc/Latest/zh/html/interfaces/index.NERoomContext.html#endRoom)|删除房间|
