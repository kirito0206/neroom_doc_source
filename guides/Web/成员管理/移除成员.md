...
3. 调用 `NERoomContext` 的 `kickMemberOut` 方法，将成员从房间移除。

    `NEKickMemberOutParams` 相关参数说明如下表所示。
  
    名称 | 描述 |
    ---- | -------------- |
    userUuid | 待移除用户的 ID。<br>用户 ID 只能填一个。 |
...
| **方法** | **功能描述** |
|:--|:--|
|[kickMemberOut](https://doc.yunxin.163.com/neroom/api-refer/web/typedoc/Latest/zh/html/interfaces/index.NERoomContext.html#kickMemberOut)|移除成员|